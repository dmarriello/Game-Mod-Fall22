...
idCVar pm_thirdPersonHeight(		"pm_thirdPersonHeight",		"1",			CVAR_GAME | CVAR_FLOAT | CVAR_NORESET, "height of camera from normal view height in 3rd person" );
idCVar pm_thirdPersonAngle(			"pm_thirdPersonAngle",		"1",			CVAR_GAME | CVAR_FLOAT | CVAR_NORESET, "direction of camera from player in 3rd person in degrees (0 = behind player, 180 = in front)" );
...
idCVar pm_thirdPersonDeath(			"pm_thirdPersonDeath",		"1",			CVAR_GAME | CVAR_BOOL, "enables third person view when player dies" );
